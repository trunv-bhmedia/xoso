...
//        die;
    ...
    function get_xstttxt_minhngoctxt($area = 2, $domain = '', $sendSMS = 0) {
		...
		$link = array(
            $domain . 'xstt/MB/mien-bac.php?f=64149658049103828&_=1496634464684',
            $domain . 'xstt/MT/mien-trung.php?f=64149658049103828&_=1496634464684',
            $domain . 'xstt/MN/mien-nam.php?f=64149658049103828&_=1496634464684'
        );
        $result = array();
