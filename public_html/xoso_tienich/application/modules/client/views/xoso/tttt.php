...
function checkUpdate(){if(counter<=0){<?php if ($area == 'MB') { ?>$.ajax({type:"GET",timeout:3000,dataType:"jsonp",jsonpCallback:"MB",cache:true,url:"http://www.xoso.com/xstt/xsmb.php",success:function(n){if(n.sec=="<?php echo md5(date('d')) ?>"){$("#xstt-block").html("");$("#kqxs-block").html("");$("#icon-load").html("");$("#kqxs-mb").show();var f=true;if(n.status==0){f=false}var j=["\\+\\+\\+\\+","\\+\\+\\+","\\+\\+","\\+"];var t=['<img src="<?php echo img_link('count_1.gif') ?>" width="13" alt="" height="13" /><img src="<?php echo img_link('count_2.gif') ?>" width="13" alt="" height="13" /><img src="<?php echo img_link('count_3.gif') ?>" width="13" alt="" height="13" /><img src="<?php echo img_link('count_4.gif') ?>" width="13" alt="" height="13" />','<img src="<?php echo img_link('count_1.gif') ?>" width="13" alt="" height="13" /><img src="<?php echo img_link('count_2.gif') ?>" width="13" alt="" height="13" /><img src="<?php echo img_link('count_3.gif') ?>" width="13" alt="" height="13" />','<img src="<?php echo img_link('count_1.gif') ?>" width="13" alt="" height="13" /><img src="<?php echo img_link('count_2.gif') ?>" width="13" alt="" height="13" />','<img src="<?php echo img_link('count_1.gif') ?>" width="13" alt="" height="13" />'];var s=n.data[0].replace(/\*\*\*\*\*/g,'<img src="<?php echo img_link('icon-xs/loading.gif') ?>" width="40" alt="" height="10" />');var e=n.data[1].replace(/\*\*\*\*\*/g,'<img src="<?php echo img_link('icon-xs/loading.gif') ?>" width="40" alt="" height="10" />');var d=n.data[2].replace(/-/g,'</strong><strong class="span-space">');var d=d.replace(/\*\*\*\*\*/g,'<img src="<?php echo img_link('icon-xs/loading.gif') ?>" width="40" alt="" height="10" />');var u=n.data[3].replace(/-/g,'</strong><strong class="span-space">');var u=u.replace(/\*\*\*\*\*/g,'<img src="<?php echo img_link('icon-xs/loading.gif') ?>" width="40" alt="" height="10" />');var r=n.data[4].replace(/-/g,'</strong><strong class="span-space">');var r=r.replace(/\*\*\*\*/g,'<img src="<?php echo img_link('icon-xs/loading.gif') ?>" width="40" alt="" height="10" />');var p=n.data[5].replace(/-/g,'</strong><strong class="span-space">');var p=p.replace(/\*\*\*\*/g,'<img src="<?php echo img_link('icon-xs/loading.gif') ?>" width="40" alt="" height="10" />');var o=n.data[6].replace(/-/g,'</strong><strong class="span-space">');var o=o.replace(/\*\*\*/g,'<img src="<?php echo img_link('icon-xs/loading.gif') ?>" width="40" alt="" height="10" />');var m=n.data[7].replace(/-/g,'</strong><strong class="span-space">');var m=m.replace(/\*\*/g,'<img src="<?php echo img_link('icon-xs/loading.gif') ?>" width="40" alt="" height="10" />');$.each(j,function(x,w){var y=new RegExp(w,"g");s=s.replace(y,t[x]);e=e.replace(y,t[x]);d=d.replace(y,t[x]);u=u.replace(y,t[x]);r=r.replace(y,t[x]);p=p.replace(y,t[x]);o=o.replace(y,t[x]);m=m.replace(y,t[x])});$("#kqxs-mb td.giaidb").html('<strong class="red font18 span-space">'+s+"</strong>");$("#kqxs-mb td.giai1").html('<strong class="span-space">'+e+"</strong>");$("#kqxs-mb td.giai2").html('<strong class="span-space">'+d+"</strong>");$("#kqxs-mb td.giai3").html('<strong class="span-space">'+u+"</strong>");$("#kqxs-mb td.giai4").html('<strong class="span-space">'+r+"</strong>");$("#kqxs-mb td.giai5").html('<strong class="span-space">'+p+"</strong>");$("#kqxs-mb td.giai6").html('<strong class="span-space">'+o+"</strong>");$("#kqxs-mb td.giai7").html('<strong class="span-space">'+m+"</strong>");$("#extra_mb").html('<tr><th class="red border-right">Đầu</th><th class="red border-right">Đuôi</th><th class="red border-right">Đầu</th><th class="red">Đuôi</th></tr>');if(typeof n.extra!="undefined"){for(var l=0;l<=4;l++){if(n.extra[l]=="undefined"||n.extra[l]==null){continue}q="bg-gray";if(l%2==0){q=""}$("#extra_mb tr:last").after('<tr><td class="'+q+' first"><strong>'+l+'</strong></td><td class="'+q+' border-right">'+n.extra[l]+'</td><td class="'+q+' border-right"><strong>'+(l+5)+'</strong></td><td class="'+q+'">'+n.extra[l+5]+"</td></tr>")}}var k=8;var h=17;var g=26;var q="";$("#kqxs-mb tr.lotorow1").html("");$("#kqxs-mb tr.lotorow2").html("");$("#kqxs-mb tr.lotorow3").html("");for(var l=0;l<=k;l++){if(n.data_b[l]=="undefined"||n.data_b[l]==null){continue}q="border-right";if(l==k){q=""}$("#kqxs-mb tr.lotorow1").append('<td class="'+q+'"><strong>'+n.data_b[l]+"</strong></td>")}for(var l=(k+1);l<=h;l++){if(n.data_b[l]=="undefined"||n.data_b[l]==null){continue}q="border-right";if(l==h){q=""}$("#kqxs-mb tr.lotorow2").append('<td class="'+q+'"><strong>'+n.data_b[l]+"</strong></td>")}for(var l=(h+1);l<=g;l++){if(n.data_b[l]=="undefined"||n.data_b[l]==null){continue}q="border-right";if(l==g){q=""}$("#kqxs-mb tr.lotorow3").append('<td class="'+q+'"><strong>'+n.data_b[l]+"</strong></td>")}if(f==true){clearInterval(timerCheck)}}}});<?php } else { ?>$.ajax({type:"GET",timeout:3000,url:"<?php echo $uri_root . 'xstt/' . $area . '?t=' . $timer; ?>",success:function(d){if(d!=1){$("#xstt-block").html(d);$("#kqxs-block").html("");$("#icon-load").html("")}}});<?php } ?>}};
