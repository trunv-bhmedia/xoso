...
//                    echo '<strong class="span-space">' . $str . '</strong>';
        ...
        <div class="sms_block">            
            <div>Soạn tin lấy số May Mắn: <strong class="red">KQ MM MB</strong> gửi <strong class="red">8317</strong></div>
            <a id="sms_mm" href="sms:8317?body=KQ MM MB">Click lấy số May Mắn XS Miền Bắc <?php echo $check_sms_mb ?></a>
            <div>Để nhận kết quả xổ số <tỉnh> 20 ngày, soạn tin : <strong class="red">KQ MB</strong> gửi <strong class="red">8717</strong></div>
            <a id="sms_kq" href="sms:8717?body=KQ MB">Click lấy kết quả XS Miền Bắc 20 ngày</a>
            <a href="<?php echo $uri_root ?>ma-tinh-thanh.html">Xem mã tỉnh khác</a>
        </div>
        <script type="text/javascript">var type=0;var userAgent=navigator.userAgent;switch(true){case (userAgent.match(/ipad/i)!=null):type=1;break;case (userAgent.match(/ipod/i)!=null||userAgent.match(/iphone/i)!=null):type=1;break;case userAgent.indexOf("iPad")>-1:type=1;break;case userAgent.indexOf("iPhone")>-1:type=1;break;case userAgent.indexOf("iPod")>-1:type=1;break;default:type=0;break}if(type==1){$("a#sms_mm").attr("href","sms:8317;body=KQ MM MB");$("a#sms_kq").attr("href","sms:8717;body=KQ MB")};</script>
...
//                    echo '<strong class="span-space">' . $v->a8 . '</strong>';
        ...
        <div class="sms_block">            
            <div>Soạn tin lấy số May Mắn: <strong class="red">KQ MM <?php echo $sms_code ?></strong> gửi <strong class="red">8317</strong></div>
            <a id="sms_mm" href="sms:8317?body=KQ MM <?php echo $sms_code ?>">Click lấy số May Mắn XS <?php echo $sms_name . ' ' . $check_sms ?></a>
            <div>Để nhận kết quả xổ số <tỉnh> 20 ngày, soạn tin : <strong class="red">KQ <?php echo $sms_code ?></strong> gửi <strong class="red">8717</strong></div>
            <a id="sms_kq" href="sms:8717?body=KQ <?php echo $sms_code ?>">Click lấy kết quả XS <?php echo $sms_name ?> 20 ngày</a>
            <a href="<?php echo $uri_root ?>ma-tinh-thanh.html">Xem mã tỉnh khác</a>
        </div>
        <script type="text/javascript">var type=0;var userAgent=navigator.userAgent;switch(true){case (userAgent.match(/ipad/i)!=null):type=1;break;case (userAgent.match(/ipod/i)!=null||userAgent.match(/iphone/i)!=null):type=1;break;case userAgent.indexOf("iPad")>-1:type=1;break;case userAgent.indexOf("iPhone")>-1:type=1;break;case userAgent.indexOf("iPod")>-1:type=1;break;default:type=0;break}if(type==1){$("a#sms_mm").attr("href","sms:8317;body=KQ MM <?php echo $sms_code ?>");$("a#sms_kq").attr("href","sms:8717;body=KQ <?php echo $sms_code ?>")};</script>
