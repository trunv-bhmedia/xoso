...
//http://xoso.com.vn/ajax/ajaxXsmtLive.ashx
//$html = curl_page2("http://xoso.tructiep.vn/array-mien-trung.html");
$html = '';
if ($html) {
    $rs_array = explode(',', $html);
} else {
    $html = curl_page2("http://xoso.com.vn/ajax/ajaxXsmtLive.ashx");
    if ($html) {
        $rs_array = explode(',', $html);
    } else {
        return null;
...
for ($i = 0; $i < count($rs_array); $i++) {
    ...
    //print_r($rs_array2); die;
    for ($j = 0; $j < count($rs_array2); $j++) {
        if ($rs_array2[0] == "?" && $rs_array2[8] != "?") {
            $quay = "dangquay";
        } elseif ($rs_array2[0] != "?") {
            $quay = "quayxong";
        } elseif ($rs_array2[8] == "?") {
    ...
    echo "<name>" . $rs_array2[12] . "</name>" . "\n";
    echo "<date>" . $rs_array2[13] . "</date>" . "\n";
