...
class cron {
    ...
    function __construct() {
        ...
        if (isset($_GET['url']) && $_GET['url'] == 1) {
            $this->_domain = 'http://www.minhngoc.co/';
        } else {
            $this->_domain = 'http://www.minhngoc.co/';
        }
    }
...
//                }
            ...
            if ($area == 2 && isset($_GET['url']) && $_GET['url'] == 3) {
                ...
                //$html = file_get_contents('http://vesophuongtrang.com/doi_ve_trung.php'); 
                // get cookie
                $m = array();
                ...
                if (isset($cookies['PHPSESSID'])) {
                    ...
                    //$html = file_get_contents('http://vesophuongtrang.com/tools/cap_nhat_truc_tiep.php?new=');
                } else {
                    return true;
                }
                ...
                /*$link = array(
                    'https://www.minhngoc.co/xstt/js_m2.js?_=1560852002390',
                    'https://www.minhngoc.co/xstt/js_m3.js?_=1560852002390',
                    'https://www.minhngoc.co/xstt/js_m1.js?_=1560852002390'
                );
			
				$link = array(
                    'https://www.minhngoc.pro/O0O/0/xstt/js_m2.js?_=1581672018993',
                    'https://www.minhngoc.pro/O0O/0/xstt/js_m3.js?_=1581672018993',
                    'https://www.minhngoc.pro/O0O/0/xstt/js_m1.js?_=1581672018993'
                );
				*/
				$link = array(
                ...
                if (strpos($html, '"run":1') === false && strpos($html, 'run:1') === false) {
					//die('2222222222');
...
//                    $magiai = 'db';
    ...
    function get_xstt_minhngoc($area, $row) {
       ...
       // );
		// https://www.minhngoc.co/1/xstt/js_m2.js?_=1562731183293
		/*$link = array(
            $this->_domain . '1/xstt/js_m2.js?_=1562731183293',
            $this->_domain . '1/xstt/js_m3.js?_=1562731183293',
            $this->_domain . '1/xstt/js_m1.js?_=1562731183293'
        );
        ...
        //$html = file_get_contents($link[$area]);
        //$html = 'kqxs.mn={run:1,tinh:"1,2,3",ntime:1757322155,delay:5000,kq:{1:{lv:"9B2",8:"12",7:"989",6:["6130","6879","4291"],5:"7638",4:["80569","41512","16142","35713","87573","98158","97674"],3:["63305","76773"],2:"95052",1:"25108",0:"863498"},2:{lv:"T36",8:"09",7:"638",6:["4621","2922","2175"],5:"4286",4:["36062","45284","24532","18265","59133","27760","42473"],3:["51846","22949"],2:"02360",1:"05568",0:"209260"},3:{lv:"25-T09K2",8:"27",7:"341",6:["9515","3293","6502"],5:"9680",4:["50754","19280","17963","26829","54657","61403","58691"],3:["30792","98527"],2:"80933",1:"42232",0:"802214"}}};';
        if (!$html) {
            $this->saveLog($link[$area] . ' - HTML empty!');
            unset($html);
            return false;
