...
// 			$link_img = $href->process_url($link_img, 'http://www.xingzuo360.cn');
...
// language=Japanese&date=2014-06-12
		$fields = array('language'=>$currentView, 'date'=>$page);
		$fields_string = '';
...
function get_content($link,$host = ''){
		$header = array();
		$header[] = "Host: $host";
		$ch = curl_init();
