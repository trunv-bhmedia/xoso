...
// Base variables
    ...
    var $username = 'appmonan';        // MySQL Username
    var $password = 'd7127bbf26ee';        // MySQL Password
    var $database = 'appmonan';        // MySQL Database
    ...
    function MyDBO($database = 'appmonan', $username = 'appmonan', $password = 'd7127bbf26ee', $hostname='localhost'){
