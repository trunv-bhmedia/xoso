...
$(document).ready(function () {
    $('.mod-text-gioi-thieu .show-more').click(function () {
        if ($('.mod-text-gioi-thieu .content-more').hasClass('active')) {
            $('.mod-text-gioi-thieu .content-more').removeClass('active');
            $('.mod-text-gioi-thieu .show-more').html('Xem thêm');

        } else {
            $('.mod-text-gioi-thieu .content-more').addClass('active');
