...
<h1>Thống kê từ diễn đàn khác</h1>
<div class="toppage">
    <span class="left">
        <ul>
            <li class="left">                
...
<div class="tableout">
    <div class="title1">
        ...
        <div class="column ta-center" style="width:40%;">Tỉnh/TP</div>
        <div class="column ta-center" style="width:14%;">Ngày</div>
    ...
    <form action="" method="post">
        <?php foreach ($rows as $k => $row): ?>
            <div class="linecate">
                ...
                <div class="column ta-left" style="width: 40%;"><?php echo $row->lname ?></div>
                <div class="column ta-center" style="width: 14%;"><?php echo date('d/m/Y', strtotime($row->date)) ?></div>
