<h1>Tạo mã nhúng kết quả Xổ Số</h1>
<div class="toppage">
...
<div class="tableout">
    <div class="title1">
        ...
        <div class="column ta-center" style="width:41%;">Tiêu đề menu</div>        
        <div class="column ta-center" style="width:21%;">Chiều rộng</div>
    ...
    <form action="" method="post">
        <?php foreach ($rows as $k => $row): ?>
            <div class="linecate">
                ...
                <div class="column ta-center" style="width: 21%;"><?php echo $row->size; ?></div>
