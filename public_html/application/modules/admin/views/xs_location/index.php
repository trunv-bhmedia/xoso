...
<div class="tableout">
    <div class="title1">
        ...
        <div class="column" style="width:15%;">Tỉnh/TP</div>
        <div class="column" style="width:15%;">SubDomain</div>
        <div class="column" style="width:10%;">ID Tỉnh/TP</div>
        <div class="column" style="width:8%;">Mã giải</div>
        <div class="column" style="width:8%;">Khu vực</div>
        <div class="column ta-center" style="width:8%;">Thời gian</div>
    ...
    <?php foreach ($rows as $k => $row): ?>
        <div class="linecate">
            ...
            <div class="column ta" style="width: 15%;"><?php echo $row->subdomain; ?></div>
            <div class="column ta" style="width: 10%;"><?php echo $row->id_tinh; ?></div>
            <div class="column ta" style="width: 8%;"><?php echo $row->code; ?></div>
            <div class="column ta" style="width: 8%;">
                <?php
                if ($row->area == 'MB')
                    echo 'Miền Bắc';
                elseif ($row->area == 'MT')
            ...
            <div class="column ta-center" style="width: 8%;"><?php echo $row->time ?></div>
