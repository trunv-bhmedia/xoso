        ...
        <form method="get" action="">
            <select name="catid" style="width: 200px;">
                ...
                <?php foreach ($xs_dreams_categories as $k => $v): ?>                            
                    <option <?php echo(isset($_GET['catid']) && $_GET['catid'] == $v->id ? 'selected="selected"' : ''); ?> value="<?php echo $v->id; ?>"><?php echo $v->title; ?></option>
                <?php endforeach; ?>
            </select>
...
<div class="tableout">
    <div class="title1">
        ...
        <div class="column ta-center" style="width:30%;">Nội dung giấc mơ</div>        
        <div class="column ta-center" style="width:11%;">Bộ số tương ứng</div>
        ...
        <?php foreach ($rows as $k => $row): ?>
            <div class="linecate">
                ...
                <div class="column ta-center" style="width: 11%;">
                    <?php echo $row->str_number ?>
                </div>
                <div class="column ta-center" style="width: 21%;"><?php echo $row->cat_name; ?></div>
