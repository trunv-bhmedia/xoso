...
<div class="tableout">
    <div class="title1">
        ...
        <div class="column ta-center" style="width:34%;">Tiêu đề</div>
        ...
        <?php foreach ($rows as $k => $row): ?>
            <div class="linecate">
                ...
                <div class="column" style="width:34%;" onmouseover="Hovercat('<?php echo $row->id; ?>')" onmouseout="Outcat('<?php echo $row->id; ?>')">
                    <a class="menu3000" target="_blank" href="<?php echo help_link($row->title_link); ?>"><?php echo $row->title ?></a><br />
