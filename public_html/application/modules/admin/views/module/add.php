        ...
        <div style="width:100%; float:left;">
            <ul class="lineadd2">
                <li>
                    ...
                    <span class="right"><input type="text" name="name" value="" style="width:60%;" /></span>
                </li>
                <li>
                    <span class="left"><?php echo lang($MODULE.'_NAME_ALIAS');?></span>
                    <span class="right"><input type="text" name="name_alias" value="" style="width:60%;" /></span>
                </li>
                <li>
                    <span class="left"><?php echo lang($MODULE.'_ORDER');?></span>
                    <span class="right"><input type="text" name="order" value="" style="width:40%;" /></span>
                </li>
            </ul>
