...
<?php
if (isset($date) && $date != '')
    echo '<div class="title-top"><h1>KẾT QUẢ XỔ SỐ NGÀY ' . str_replace('-', '/', $date) . '</h1><div class="tabs-note clearfix"><a class="span-tttt" href="' . $uri_root . 'tuong-thuat-truc-tiep-ket-qua-xo-so.html">Tường thuật trực tiếp >></a><a class="span-tkxs" href="' . $uri_root . 'thong-ke-quan-trong.html">Thống kê xổ số</a></div></div>';
else
    echo '<div class="title-top"><h1>KẾT QUẢ XỔ SỐ</h1><div class="tabs-note clearfix"><a class="span-tttt" href="' . $uri_root . 'tuong-thuat-truc-tiep-ket-qua-xo-so.html">Tường thuật trực tiếp >></a><a class="span-tkxs" href="' . $uri_root . 'thong-ke-quan-trong.html">Thống kê xổ số</a></div></div>';
