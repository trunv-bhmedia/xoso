...
<?php $DT6x36_time=strtotime($xsdt['DT6x36']->date);$DT123_time=strtotime($xsdt['DT123']->date);$TT_time=strtotime($xsdt['TT']->date);?>
...
<?php $xsmn=array();$loto_tinh='';$loto_title='';$loto_arr=array();
...
<div class="block_db_content">
<ul class="list-tinh">
<?php foreach($xsmn as $alias=>$value){$width='w188';if(count($xsmn)==2)$width='w282';elseif(count($xsmn)==4)$width='w141';?>
...
<ul class="list-pro">
<?php foreach($location_today['MN'] as $value){echo '<li><a href="'.$uri_root.$value->alias.'.html"><span>'.$value->name.'</span></a></li>';}?>
</ul>
<ul class="list-editor">
<?php foreach($location_today['MN'] as $value){echo '<li>Để nhận kết quả xổ số <strong>'.$value->name.'</strong> sớm nhất, soạn tin <span>KQ '.$value->code.'</span> gửi <span>8017</span></li>';}?>
</ul>
</div>
</div>
<div class="line-red">&nbsp;</div>
...
<?php $xsmt=array();$loto_tinh='';$loto_title='';$loto_arr=array();
...
<div class="block_db_content">
<ul class="list-tinh">
<?php foreach($xsmt as $alias=>$value){$width='w188';if(count($xsmt)==2)$width='w282';elseif(count($xsmt)==4)$width='w141';?>
<li class="<?php echo $width?>">
<div>
<a href="<?php echo $uri_root.$alias?>.html"><?php echo $value->name?></a>
<div class="title_db">Giải đặc biệt</div>
...
<div class="box-gray spacenone">
<ul class="list-pro">
<?php foreach($location_today['MT'] as $value){echo '<li><a href="'.$uri_root.$value->alias.'.html"><span>'.$value->name.'</span></a></li>';}?>
</ul>
<ul class="list-editor">
<?php foreach($location_today['MT'] as $value){echo '<li>Để nhận kết quả xổ số <strong>'.$value->name.'</strong> sớm nhất, soạn tin <span>KQ '.$value->code.'</span> gửi <span>8017</span></li>';}?>
</ul>
</div>
</div>
<div class="line-red">&nbsp;</div>
...
<div class="line-red">&nbsp;</div>
<?php $db_dau='';$loto_dau='';foreach($items['dau'] as $k=>$v){if($k==0){$db_dau.='<tr>';$loto_dau.='<tr>';}if($k==5){$db_dau.='</tr><tr>';$loto_dau.='</tr><tr>';}$db_dau.='<td><strong class="red">'.$k.'</strong> ('.$items['dau_dacbiet'][$k].' lượt)</td>';$loto_dau.='<td><strong class="red">'.$k.'</strong> ('.$v.' lượt)</td>';if($k==9){$db_dau.='</tr>';$loto_dau.='</tr>';}}$db_duoi='';$loto_duoi='';foreach($items['duoi'] as $k=>$v){if($k==0){$db_duoi.='<tr>';$loto_duoi.='<tr>';}if($k==5){$db_duoi.='</tr><tr>';$loto_duoi.='</tr><tr>';}$db_duoi.='<td><strong class="red">'.$k.'</strong> ('.$items['duoi_dacbiet'][$k].' lượt)</td>';$loto_duoi.='<td><strong class="red">'.$k.'</strong> ('.$v.' lượt)</td>';if($k==9){$db_duoi.='</tr>';$loto_duoi.='</tr>';}}?>
<br/>
