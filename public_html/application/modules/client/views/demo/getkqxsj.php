...
?>
var log = $('box_kqxs');
log.setHTML('<div class="title clearfix"><strong class="left xsmb">KQXS</strong><div class="right space-select"><div class="box-select left"><?php echo $location ?></div><div class="box-select left" id="list_date"><?php echo $ngay ?></div></div></div>');
...
var myScript = Asset.javascript('<?php echo $uri_root ?>getkqxsj-'+kqxs_tinh+'.js?'+$time());
},500);
}
...
setTimeout(function(){
log.innerHTML += '<div class="onidprocess"><img src="<?php echo img_link('processing.gif'); ?>" /></div>';
var myScript = Asset.javascript('<?php echo $uri_root ?>getkqxsj-'+kqxs_tinh+'/'+kqxs_ngay+'.js?'+$time());
},500);
}
...
$$("#box_kqxs strong.xsmb").setHTML(titlexs);
