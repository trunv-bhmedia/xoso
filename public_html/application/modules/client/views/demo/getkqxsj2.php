...
?>
var log = $('box_kqxs');
log.set('html','<div class="title clearfix"><strong class="left xsmb">KQXS</strong><div class="right space-select"><div class="box-select left"><?php echo $location ?></div><div class="box-select left" id="list_date"><?php echo $ngay ?></div></div></div>');
log.innerHTML += '<div class="box_kqxs_mini"><div class="contentxs"><?php echo $str ?></div></div>';
function getnew_boxkqxs(){
var e = document.getElementById("box_kqxs_tinh");
var kqxs_tinh = e.options[e.selectedIndex].value;
setTimeout(function(){
log.innerHTML += '<div class="onidprocess"><img src="<?php echo img_link('processing.gif'); ?>" /></div>';
var myScript = Asset.javascript('<?php echo $uri_root ?>getkqxsj2-'+kqxs_tinh+'.js?'+$time());
},500);
}
function getnew_boxkqxs_ngay(){
var e = document.getElementById("box_kqxs_tinh");
var kqxs_tinh = e.options[e.selectedIndex].value;
var e = document.getElementById("box_kqxs_ngay");
var kqxs_ngay = e.options[e.selectedIndex].value;
setTimeout(function(){
log.innerHTML += '<div class="onidprocess"><img src="<?php echo img_link('processing.gif'); ?>" /></div>';
var myScript = Asset.javascript('<?php echo $uri_root ?>getkqxsj2-'+kqxs_tinh+'/'+kqxs_ngay+'.js?'+$time());
},500);
}
...
if(crong<220) $$("#box_kqxs a.link-home").setStyle('display','none');
if(crong<215 && crong>=200) $("#box_kqxs .space-select .box-select select").setStyle('width','80px');
}
$$("#box_kqxs strong.xsmb").set('html',titlexs);
$$("#box_kqxs .title").setStyle('background',bgcolor);
$$("#box_kqxs .title strong").setStyle('color',titlecolor);
$$(".giaidb").setStyle('color',dbcolor);
$$("#box_kqxs").setStyle('width',kqwidth);
$$("#box_kqxs td,#box_kqxs div,#box_kqxs select,#box_kqxs a").setStyle('font-size',fsize+'px');
$$("#box_kqxs div.xoso-home,#box_kqxs div.xoso-home a").setStyle('font-size','9px');
if(tt==1) $$("#box_kqxs .ttxs").setStyle('display','table-row');
else $$("#box_kqxs .ttxs").setStyle('display','none');
if(cal==1) $$("#box_kqxs #list_date").setStyle('display','table-row');
else $$("#box_kqxs #list_date").setStyle('display','none');
}
updatecolor();