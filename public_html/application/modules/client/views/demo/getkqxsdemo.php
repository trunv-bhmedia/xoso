...
$lname = '';
$statistics_alias = '';
$location = '<select name="tinh" id="box_kqxs_tinh_' . $did . '" onchange="getnew_boxkqxs_' . $did . '();">';
...
$ngay = '<select name="ngay" id="box_kqxs_ngay_' . $did . '" onchange="getnew_boxkqxs_ngay_' . $did . '();">';
...
?>
$("#box_kqxs_<?php echo $did ?>").html('');
$("#box_kqxs_<?php echo $did ?>").append('<div class="title clearfix">'
    ...
    +'<div class="right space-select">'
        ...
        +'</div>'
    +'</div>');
$("#box_kqxs_<?php echo $did ?>").append('<div class="box_kqxs_mini"><div class="contentxs"><?php echo $str ?></div></div>');
function getnew_boxkqxs_<?php echo $did ?>(){
setTimeout(function(){
$("#box_kqxs_<?php echo $did ?>").append('<div class="onidprocess"><img src="<?php echo img_link('processing.gif'); ?>" /></div><script type="text/javascript" src="<?php echo $uri_root ?>getkqxsdemo-'+$("#box_kqxs_tinh_<?php echo $did ?>").val()+'.js?id=<?php echo $did ?>"></script>');
},500);
}
function getnew_boxkqxs_ngay_<?php echo $did ?>(){
setTimeout(function(){
$("#box_kqxs_<?php echo $did ?>").append('<div class="onidprocess"><img src="<?php echo img_link('processing.gif'); ?>" /></div><script type="text/javascript" src="<?php echo $uri_root ?>getkqxsdemo-'+$("#box_kqxs_tinh_<?php echo $did ?>").val()+'/'+$("#box_kqxs_ngay_<?php echo $did ?>").val()+'.js?id=<?php echo $did ?>"></script>');
},500);
}
function jstrpos_<?php echo $did ?>(haystack,needle,offset){var i=(haystack+'').indexOf(needle,(offset||0));return i===-1?false:i}
function updatecolor_<?php echo $did ?>(){
if(jstrpos_<?php echo $did ?>(kqwidth<?php echo $did ?>,'px')>0){
crong=kqwidth<?php echo $did ?>.replace('px','');
if(crong<220) $("#box_kqxs_<?php echo $did ?> a.link-home").css('display','none');
if((crong<270||crong>=330) && fsize==12) $("#box_kqxs_<?php echo $did ?> strong.xsmb").text('Kết quả Xổ Số');
if(crong<215 && crong>=200) $("#box_kqxs_<?php echo $did ?> .space-select .box-select select").css('width','80px');
}
$("#box_kqxs_<?php echo $did ?> .title").css('background',bgcolor);
$("#box_kqxs_<?php echo $did ?> .title strong").css('color',titlecolor);
$(".giaidb").css('color',dbcolor);
$("#box_kqxs_<?php echo $did ?>").css('width',kqwidth<?php echo $did ?>);
$("#box_kqxs_<?php echo $did ?> td,#box_kqxs_<?php echo $did ?> div,#box_kqxs_<?php echo $did ?> select,#box_kqxs_<?php echo $did ?> a").css('font-size',fsize+'px');
$("#box_kqxs_<?php echo $did ?> div.xoso-home,#box_kqxs_<?php echo $did ?> div.xoso-home a").css('font-size','9px');
if(tt=="true") $("#box_kqxs_<?php echo $did ?> .ttxs").css('display','table-row');
else $("#box_kqxs_<?php echo $did ?> .ttxs").css('display','none');
}
updatecolor_<?php echo $did ?>();