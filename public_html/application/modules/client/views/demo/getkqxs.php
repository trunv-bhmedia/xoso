...
if(crong<220) $("#box_kqxs a.link-home").css('display','none');
if((crong<270||crong>=330) && fsize==12) $("#box_kqxs strong.xsmb").text('Kết quả Xổ Số');
if(crong<215 && crong>=200) $("#box_kqxs .space-select .box-select select").css('width','80px');
}
...
$("#box_kqxs td,#box_kqxs div,#box_kqxs select,#box_kqxs a").css('font-size',fsize+'px');
$("#box_kqxs div.xoso-home,#box_kqxs div.xoso-home a").css('font-size','9px');
if(tt=="true") $("#box_kqxs .ttxs").css('display','table-row');
else $("#box_kqxs .ttxs").css('display','none');
}
updatecolor();