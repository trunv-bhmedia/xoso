...
<div class="title title-red">
    <div class="title-right" style="padding:0 5px 0 295px">
        <ul class="tabs clearfix">
            <li><a href="<?php echo $uri_root ?>soi-cau.html?setmode=full">Soi cầu toàn diện</a></li>
            <li class="active"><a href="<?php echo $uri_root ?>soi-cau.html?setmode=num">Tìm cầu cho cặp số</a></li>
        </ul>
    </div>
</div>
...
<div class="contentcontainer">
    ...
    <div class="vitri_block" style="padding-left:350px">
        <?php
        if ($timcau != '') {
