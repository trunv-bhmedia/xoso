<h1 style="position: absolute; text-indent: -99999px">Quay số cầu may</h1>
...
//        echo '<div class="alert_vip">Bạn không được phép sử dụng chức năng Quay số cầu may<br/>';
...
<script type="text/javascript">
    ...
    <?php //}else{?>
    //function timedCount(){alert('Bạn phải là thành viên VIP mới được quay số')};
    <?php //}?>
</script>