...
<meta property="og:image" content="http://www.xoso.com/public/client/images/logo.png" />
<meta http-equiv="refresh" content="900" />
<link rel="canonical" href="" /><link rel="alternate" media="handheld" href="" />
<link type="image/x-icon" href="http://www.xoso.com/public/client/images/favicon.ico" rel="shortcut icon" />
<link type="text/css" rel="stylesheet" href="http://www.xoso.com/min/g=css1411" />
<script type="text/javascript" src="http://www.xoso.com/public/client/js/jquery-1.9.1.min.js"></script>
<script type="text/javascript" src="http://www.xoso.com/public/client/js/jquery-blink.js"></script>
<script type="text/javascript" src="http://www.xoso.com/public/client/js/flipclock.min.js"></script>
<script type="text/javascript" src="http://www.xoso.com/public/client/js/clock.js"></script>
 <!-- <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/3.7.2/animate.min.css"> -->
<link type="text/css" rel="stylesheet" href="http://www.xoso.com/public/client/css/livexoso.css?t=<?php echo strtotime('now'); ?>" />
<style>
	#xstt-block-mn table td:not(:first-child) {
		width: calc((100% - 100px)/3);
	}

	#xstt-block-mt table td:not(:first-child) {
		width: calc((100% - 100px)/<?= count($location_today[$areamt]); ?>);
	}
			...
			<div class="content">
				...
				<div class="headerMN">
					...
					<?php if($count12h <= 0) { ?>
						...
						<div class="locarea locarea-mt" style="<?php echo count($location_lastday[$areamt]) == 2 ? 'width: 25%' : 'width: 35%'?>">
						<?php
					...
					<?php } else { ?>
						...
						<div class="locarea locarea-mt" style="<?php echo count($location_today[$areamt]) == 2 ? 'width: 25%' : 'width: 35%'?>">
						<?php
				...
				<?php if($count12h <= 0) { ?>
					<div id="giai-mn" style="<?php echo count($location_lastday[$areamt]) == 2 ? 'width: 50%' : 'width: 40%'?>">
					<?php $this->load->view($tmplmn); ?>
					</div>
					<div id="giai-mt" style="<?php echo count($location_lastday[$areamt]) == 2 ? 'width: 25%' : 'width: 35%'?>">
					<?php $this->load->view($tmplmt); ?>
					</div>
					<div id="giai-mb">
					<?php $this->load->view($tmplmb); ?>
					</div>
				<?php } else { ?>
					<div id="giai-mn" style="<?php echo count($location_today[$areamt]) == 2 ? 'width: 50%' : 'width: 40%'?>">
					<?php $this->load->view($tmplmn); ?>
					</div>
					<div id="giai-mt" style="<?php echo count($location_today[$areamt]) == 2 ? 'width: 25%' : 'width: 35%'?>">
					<?php $this->load->view($tmplmt); ?>
					</div>
					<div id="giai-mb">
					<?php $this->load->view($tmplmb); ?>
