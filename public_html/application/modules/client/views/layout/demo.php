...
<?php foreach($items as $value){echo '<li><a href="'.$uri_root.'demo/index.html#demo'.$value->id.'">'.$value->title.'</a></li>';}?>
...
<?php foreach($doitac as $value){echo '<div class="item"><div class="img"><span class="helper"></span><a href="'.$value->link.'"><img src="'.site_url($value->image).'" /></a></div><div class="name"><a href="'.$value->link.'">'.$value->title.'</a></div></div>';}?>
</div>
<?php }?>
</div>
<div class="col-main">
