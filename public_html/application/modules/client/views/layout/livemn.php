		...
		<div class="content-wrap">
			<div class="content">
				...
				<div class="headerMN">
					...
					<?php if($count12h <= 0) { ?>
						<div class="locarea locarea-mn" style="width:95%">
						<?php
							$stylemn = count($location_lastday[$areamn]) == 4 ? 'width: 25%' : 'width: 33.33%';
					...
					<?php } else { ?>
						<div class="locarea locarea-mn" style="width: 95%">
						<?php
							$stylemn = count($location_today[$areamn]) == 4 ? 'width: 25%' : 'width: 33.33%';
				...
				<?php if($count12h <= 0) { ?>
					<div id="giai-mn" style="width: 100% !important">
