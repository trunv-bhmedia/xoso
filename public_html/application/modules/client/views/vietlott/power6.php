...
//    alert('gg');return false;
        ...
        for (var i = 1; i <= 6; i++) {
            ++optionInput;
            htmlAppen += "<li class='input tel'><input onkeyup='cbvGetChangePower(" + optionInput + ", this.value)'  name='number_soi[" + optionInput + "]' class='number-xsmt number-xsmt-0 index-" + optionInput + "' placeholder='--' maxlength='2' autocomplete='off' type='text' id='number" + optionInput + "' data-id='" + optionInput + "'> </li>";
        }
        htmlAppen += "</ul>";
...
<div class="main-vietlot-page-m6 main-vietlot-page-m6-2 main-vietlot-page-pow6">
    ...
    <section class="module mod-giai-da-quay" id="result-games">
        <div class="jackpost-xx mega645-box" >
            <h1 class="jackpost-xx-h2">KẾT QUẢ TRÚNG THƯỞNG POWER 6/55<small>Ngày quay thưởng <?php echo date('d/m/Y', strtotime($vietlottpower1->date)); ?></small></h1>
                            ...
                            <tbody>
                                ...
                                for ($i = 0; $i < 5; $i++) {
                                    ...
                                    <tr class="web_bg_Trang">
                                        ...
                                        <td><?php echo $data_mega_content_item->content->nd->jp->gt; ?></td>
                                        <td><?php echo $data_mega_content_item->content->nd->jp2->gt; ?></td>
                                    </tr>
                                <?php } ?>                                        
                            </tbody>
                        </table>                               
    ...
    <section style="padding: 20px 0; text-align: justify; font-size: 14px;line-height: 1.5">
        <p>
