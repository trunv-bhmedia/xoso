...
<div class="main-vietlot-page-m6 main-vietlot-page-max4">
                            ...
                            <table width="100%" cellspacing="1" cellpadding="0" border="0" bgcolor="#dedede">
                                <tbody>
                                    ...
                                    <tr class="web_bg_Trang">
                                        ...
                                        <?php $g21 = $data_max_content->content->db->g2->s1; ?>
                                        <?php $g22 = $data_max_content->content->db->g2->s2; ?>
                                        <td colspan="6" class="web_XS_2 chukq"><?php echo trim($g21[0].$g21[1].$g21[2].$g21[3]); ?></td>
                                        <td colspan="6" class="web_XS_2 chukq"><?php echo trim($g22[0].$g22[1].$g22[2].$g22[3]); ?></td>
                                    </tr>
                                    <tr class="web_bg_Trang">
                                        <td class="web_XS_1 chugiai">Giải ba</td>
                                        <?php $g31 = $data_max_content->content->db->g3->s1; ?>
                                        <?php $g32 = $data_max_content->content->db->g3->s2; ?>
                                        <?php $g33 = $data_max_content->content->db->g3->s3; ?>
                                        <td colspan="4" class="web_XS_2 chukq"><?php echo trim($g31[0].$g31[1].$g31[2].$g31[3]); ?></td>
                                        <td colspan="4" class="web_XS_2 chukq"><?php echo trim($g32[0].$g32[1].$g32[2].$g32[3]); ?></td>
                                        <td colspan="4" class="web_XS_2 chukq"><?php echo trim($g33[0].$g33[1].$g33[2].$g33[3]); ?></td>
                                    </tr>
                                    <tr class="web_bg_Trang">
                                        <td class="web_XS_1 chugiai">Giải khuyến khích 1</td>
										<?php $kk1 = $data_max_content->content->db->kk1; ?>
                                        <td colspan="12" class="web_XS_2 chukq"><?php echo trim($kk1[0].$kk1[1].$kk1[2].$kk1[3]); ?></td>
                                    </tr>
                                    <tr class="web_bg_Trang">
                                        <td class="web_XS_1 chugiai">Giải khuyến khích 2</td>
										<?php $kk2 = $data_max_content->content->db->kk2; ?>
                                        <td colspan="12" class="web_XS_2 chukq"><?php echo trim($kk2[0].$kk2[1].$kk2[2].$kk2[3]); ?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
    ...
    <section class="module mod-dove-max4d">
        <div class="form-soi-cau">
            <h1 class="text-do-ve"><i class="fa fa-compass"></i> Dò vé số</h1>
    ...
    <br>
    <div class="box box-html" style="font-size: 14px; line-height: 1.5">
    ...
    <aside id="page-lien-quan" class="page-lq-choithu ketqua-xt">
        <h2 class="title-xt-vl"> &nbsp;xổ số VIETLOTT</h2>
        <ul class="col-xs-6 left-col-ct">
            <li><a href="/vietlott/xo-so-power-6-55-vietlott.html"><span>Kết quả Power 6/55</span></a></li>
            <li><a href="/vietlott/mega6.html"><span>Kết quả Mega 6/45</span></a></li>
            <li><a href="/vietlott/max4d.html"><span>Kết quả Max 4D</span></a></li>
        </ul>
        <ul class="col-xs-6 right-col-ct">
