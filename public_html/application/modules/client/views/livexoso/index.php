...
<div class="box-editor">Soạn <strong class="red">TT MB</strong> gửi <strong class="red">8588</strong></div>
</div>';
...
if (isset($date) && $date != '')
echo '<div class="title-top"><h1>KẾT QUẢ XỔ SỐ MIỀN BẮC NGÀY ' . str_replace('-', '/', $date) . '</h1><div class="tabs-note clearfix"><a class="span-tttt" href="' . $uri_root . 'tuong-thuat-truc-tiep-ket-qua-xo-so/mien-bac.html">Tường thuật trực tiếp >></a><a class="span-tkxs" href="' . $uri_root . 'thong-ke-quan-trong.html">Thống kê xổ số</a></div></div>';else
echo '<div class="title-top"><h1>KẾT QUẢ XỔ SỐ MIỀN BẮC</h1><div class="tabs-note clearfix"><a class="span-tttt" href="' . $uri_root . 'tuong-thuat-truc-tiep-ket-qua-xo-so/mien-bac.html">Tường thuật trực tiếp >></a><a class="span-tkxs" href="' . $uri_root . 'thong-ke-quan-trong.html">Thống kê xổ số</a></div></div>';foreach ($items as $k => $v) {
...
if ($v->area != 'MB')
$shared_content.=', giải tám: ' . $v->a8;$alias_date = $v->alias . '/' . $date_ve_do;
...
<?php $str = str_replace('-', '</strong><strong class="span-space">', $v->data[2]);
...
<?php $str = str_replace('-', '</strong><strong class="span-space">', $v->data[3]);
echo '<strong class="span-space">' . $str . '</strong>';
?>
</td>
</tr>
...
<?php $str = str_replace('-', '</strong><strong class="span-space">', $v->data[4]);
echo '<strong class="span-space">' . $str . '</strong>';
?>
</td>
</tr>
...
<?php $str = str_replace('-', '</strong><strong class="span-space">', $v->data[5]);
echo '<strong class="span-space">' . $str . '</strong>';
?>
</td>
</tr>
...
<?php $str = str_replace('-', '</strong><strong class="span-space">', $v->data[6]);
echo '<strong class="span-space">' . $str . '</strong>';
?>
</td>
</tr>
...
<?php $str = str_replace('-', '</strong><strong class="span-space">', $v->data[7]);
echo '<strong class="span-space">' . $str . '</strong>';
?>
</td>
<td></td>
...
<ul class="list-editor space1">
    <li>Đ ể nhận kết quả xổ số <strong>Miền Bắc</strong> sớm nhất, soạn tin <span>BHX KQ MB</span> gửi <span>8188</span></li>
</ul>
...
if ($alias == $url_mientrung || $alias == $url_miennam) {
    ...
    //echo '</div>';
    //}
    if (!isset($thu)) echo '<h1>KẾT QUẢ XỔ SỐ ' . $l_area . '</h1>';
    else echo '<h1>KẾT QUẢ XỔ SỐ ' . $l_area . ' - ' . $thu . '</h1>';
} else {
    // echo '<div class="box-tt clearfix">
    // <strong class="strong-tt">Trực tiếp kết quả Xổ Số ' . $items[0]->name . '<br />
    // Nhận kết quả nhanh siêu tốc</strong>
    // <div class="box-editor">Soạn <strong class="red">TT ' . $items[0]->code . '</strong> gửi <strong class="red">8588</strong></div>
    // </div>';
    ...
    //}
    if (isset($date) && $date != '')
        echo '<div class="title-top"><h1>KẾT QUẢ XỔ SỐ ' . mb_strtoupper($items[0]->name, 'UTF-8') . ' NGÀY ' . str_replace('-', '/', $date) . '</h1><div class="tabs-note clearfix"><a class="span-tttt" href="' . $url_tttt . '">Tường thuật trực tiếp >></a><a class="span-tkxs" href="' . $uri_root . 'thong-ke-quan-trong.html">Thống kê xổ số</a></div></div>';
    else
        echo '<div class="title-top"><h1>KẾT QUẢ XỔ SỐ ' . mb_strtoupper($items[0]->name, 'UTF-8') . '</h1><div class="tabs-note clearfix"><a class="span-tttt" href="' . $url_tttt . '">Tường thuật trực tiếp >></a><a class="span-tkxs" href="' . $uri_root . 'thong-ke-quan-trong.html">Thống kê xổ số</a></div></div>';
...
foreach ($items as $k => $v) {
    ...
    <div class="box-result">
        <table class="tbl-tt tbl-main-tt kqmiennam">
            ...
            <tr>
                <td class="bg-gray border-right">Giải nhì</td>
                <td class="bg-gray border-right giai2">
                    <?php $str = str_replace(array('-'), array('</strong><strong class="span-space">'), $v->a2);
                        echo '<strong class="span-space">' . $str . '</strong>';
                    ?>
                </td>
            </tr>
            <tr>
                <td class="border-right">Giải ba</td>
                <td class="border-right giai3">
                    <?php $str = str_replace(array('-'), array('</strong><strong class="span-space">'), $v->a3);
                        echo '<strong class="span-space">' . $str . '</strong>';
                    ?>
                </td>
            </tr>
            ...
            <td class="bg-gray border-right">Giải tư</td>
            <td class="bg-gray border-right giai4">
            <?php $str = str_replace(array('-'), array('</strong><strong class="span-space">'), $v->a4);
            echo '<strong class="span-space">' . $str . '</strong>';
            ?>
            </td>
            </tr>
            ...
            <td class="border-right">Giải năm</td>
            <td class="border-right giai5">
            <?php $str = str_replace(array('-'), array('</strong><strong class="span-space">'), $v->a5);
            echo '<strong class="span-space">' . $str . '</strong>';
            ?>
            </td>
            </tr>
            ...
            <td class="bg-gray border-right">Giải sáu</td>
            <td class="bg-gray border-right giai6">
            <?php $str = str_replace(array('-'), array('</strong><strong class="span-space">'), $v->a6);
            echo '<strong class="span-space">' . $str . '</strong>';
            ?>
            </td>
            </tr>
            ...
            <td class="border-right">Giải bảy</td>
            <td class="border-right giai7">
            <?php $str = str_replace(array('-'), array('</strong><strong class="span-space">'), $v->a7);
            echo '<strong class="span-space">' . $str . '</strong>';
            ?>
            </td>
            </tr>
    ...
    <div class="tabs-note col3 clearfix">
        ...
        <a class="span-dvo" href="<?php echo $uri_root ?>do-ve-so.html">&nbsp;</a>
        <a class="span-quayxs" href="<?php echo $uri_root ?>cung-quay-xo-so.html<?php echo $items[0]->area == 'MT' ? '?t=2' : '?t=3' ?>">&nbsp;</a>
        <a class="span-vs" href="<?php echo $uri_root ?>ve-so-<?php echo $items[0]->area == 'MT' ? 'mien-trung' : 'mien-nam' ?>.html">&nbsp;</a>
    </div>
...
<?php  if (isset($statistics) && $statistics == true) { ?>
