...
function clockUpdate(){if(counter>-1){mb=countDown(counter);counter=mb.time;$("#xstt .hour").html(mb.hour);$("#xstt .min").html(mb.min);$("#xstt .sec").html(mb.sec)}else{clearInterval(timerClock)}}
