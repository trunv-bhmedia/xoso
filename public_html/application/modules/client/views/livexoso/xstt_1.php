<?php $time=date('H:i');$timer=date('H:i',strtotime($timer));if(!$data){echo 1;die();}$days=array('0'=>'Chủ nhật','1'=>'Thứ 2','2'=>'Thứ 3','3'=>'Thứ 4','4'=>'Thứ 5','5'=>'Thứ 6','6'=>'Thứ 7');switch($area){case 'MB':$l_area='Truyền thống';$time_end='18:00';break;case 'MT':$l_area='Miền Trung';$time_end='17:00';break;case 'MN':$l_area='Miền Nam';$time_end='16:00';break;}if($time>=$time_end&&$time<$timer){echo 1;die();}if($time<$time_end){$date=date('d/m/Y',strtotime('-1 day'));$date_ve_do=date('d-m-Y',strtotime('-1 day'));$datew=date('w',strtotime('-1 day'));}else{$date=date('d/m/Y');$date_ve_do=date('d-m-Y');$datew=date('w');}$cols=count(get_object_vars($data));$check=true;$arr_search=array('++++','+++','++','+');$arr_replace=array('<img src="'.img_link('count_1.gif').'" width="13" alt="" height="13" /><img src="'.img_link('count_2.gif').'" width="13" alt="" height="13" /><img src="'.img_link('count_3.gif').'" width="13" alt="" height="13" /><img src="'.img_link('count_4.gif').'" width="13" alt="" height="13" />','<img src="'.img_link('count_1.gif').'" width="13" alt="" height="13" /><img src="'.img_link('count_2.gif').'" width="13" alt="" height="13" /><img src="'.img_link('count_3.gif').'" width="13" alt="" height="13" />','<img src="'.img_link('count_1.gif').'" width="13" alt="" height="13" /><img src="'.img_link('count_2.gif').'" width="13" alt="" height="13" />','<img src="'.img_link('count_1.gif').'" width="13" alt="" height="13" />');if($area=='MB'){$v=$data->MB;if($v->status==0)$check=false;$title_share='Xổ Số '.$v->name.' - '.$days[$datew].' ngày '.$date;$shared_content='Xổ Số '.$v->name.' ngày '.$date.',';$shared_content.=' giải DB: '.$v->data[0].',';$shared_content.=' giải nhất: '.$v->data[1].',';$shared_content.=' giải nhì: '.$v->data[2].',';$shared_content.=' giải ba: '.$v->data[3].',';$shared_content.=' giải tư: '.$v->data[4].',';$shared_content.=' giải năm: '.$v->data[5].',';$shared_content.=' giải sáu: '.$v->data[6].',';$shared_content.=' giải bảy: '.$v->data[7];$alias_date=$v->alias.'/'.$date_ve_do;$curPageURL=urlencode($uri_root.$alias_date.'.html');$url_google='https://www.google.com/bookmarks/mark?op=add&amp;bkmk='.$curPageURL.'&amp;title='.urlencode($title_share).'&amp;annotation='.$shared_content;$url_facebook='http://www.facebook.com/sharer.php?u='.$curPageURL;$url_yahoo='http://www.addtoany.com/add_to/yahoo_mail?linkurl='.$curPageURL.'. '.$shared_content.'&amp;type=page&amp;linkname='.$title_share.'&amp;linknote=';$url_email='mailto:?subject='.formatMail($title_share).'&amp;body='.$curPageURL.'. '.formatMail($shared_content);?>
