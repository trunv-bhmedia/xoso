...
<tr>
    <td>KH GĐB</td>
    <td style="text-align: center;"><strong><?php echo $khtt; ?></strong></td>
</tr>
<tr>
<td class="bg-gray border-right">Giải đặc biệt</td>
<td class="bg-gray border-right giaidb" style="line-height:90px !important;">
<?php $str = str_replace('*****', '<img src="' . img_link('icon-xs/loading.gif') . '" width="40" alt="" height="10" />', $v->data[0]);
    ...
    echo '<strong class="red font18 span-space" style="font-size:70px !important;">' . $str . '</strong>'; ?>
</td>
...
<td class="border-right giai1 font70014" style="line-height:50px !important;">
<?php $str = str_replace('*****', '<img src="' . img_link('icon-xs/loading.gif') . '" width="40" alt="" height="10" />', $v->data[1]);
    $str = str_replace($arr_search, $arr_replace, $str);
    echo '<strong class="span-space" style="font-size:50px !important;">' . $str . '</strong>'; ?>
</td>
</tr>
<tr>
<td class="bg-gray border-right">Giải nhì</td>
<td class="bg-gray border-right giai2 font70014" style="text-align:center;font-size:50px;line-height:50px !important;">
...
<td class="border-right giai3 font70014" style="text-align:center;font-size:50px;line-height:70px !important;">
<?php $str = str_replace(array(
        '-',
        '*****'
    ) , array(
    ...
    $str_1 = array(
        isset($array_str[0]) ? $array_str[0] : 00000,
        isset($array_str[1]) ? $array_str[1] : 00000,
        isset($array_str[2]) ? $array_str[2] : 00000,
    );

    $str_2 = array(
        isset($array_str[3]) ? $array_str[3] : 00000,
        isset($array_str[4]) ? $array_str[4] : 00000,
        isset($array_str[5]) ? $array_str[5] : 00000,
    );

    echo implode('-', $str_1) . '</br>' . implode('-', $str_2); ?>
</tr>
<tr>
<td class="bg-gray border-right">Giải tư</td>
<td class="bg-gray border-right giai4 font70014" style="text-align:center;font-size:50px;line-height:50px !important;">
<?php $str = str_replace(array(
        '-',
        '****'
    ) , array(
...
<td class="border-right giai5 font70014" style="text-align:center;font-size:70px;line-height:100px !important;">
<?php $str = str_replace(array(
        '-',
        '****'
    ) , array(
...
<td class="bg-gray border-right giai6 font70014" style="text-align:center;font-size:5px;line-height:50px !important;">
<?php $str = str_replace(array(
        '-',
        '***'
    ) , array(
...
<td class="border-right giai7 font70014" style="text-align:center;font-size:50px;line-height:70px !important;">
<?php $str = str_replace(array(
        '-',
        '**'
    ) , array(
...
else
{
    ...
    foreach ($data as $value)
    {
        ...
        $str = str_replace($arr_search, $arr_replace, $str);
        $g8 .= '<td class="' . $class . 't-cen font70014" style="font-size:70px;line-height:60px !important;"><strong class="red">' . $str . '</strong></td>';
        $str = str_replace('***', '<img src="' . img_link('icon-xs/loading.gif') . '" width="40" alt="" height="10" />', $value->data[7]);
        $str = str_replace($arr_search, $arr_replace, $str);
        $g7 .= '<td class="' . $class . 'bg-gray t-cen font70014" style="font-size:50px;line-height:50px !important;">' . $str . '</td>';
        ...
        $str_1 = implode('-', $str_1) . '</br>' . implode('-', $str_2);

        $g6 .= '<td class="' . $class . 't-cen font70014" style="font-size:50px;line-height:50px !important;">' . $str_1 . '</td>';
        $str = str_replace('****', '<img src="' . img_link('icon-xs/loading.gif') . '" width="40" alt="" height="10" />', $value->data[5]);
        $str = str_replace($arr_search, $arr_replace, $str);
        $g5 .= '<td class="' . $class . 'bg-gray t-cen font70014" style="font-size:50px;line-height:50px !important;">' . $str . '</td>';
        $str = str_replace(array(
            '-',
            '*****'
        ) , array(
        ...
        $str_4 = array(
            isset($array_str[6]) ? $array_str[6] : 00000,
        );

        $str_1 = implode('-', $str_1) . '</br>' . implode('-', $str_2) . '</br>' . implode('-', $str_3) . '</br>' . implode('-', $str_4); 

        $g4 .= '<td class="' . $class . 't-cen font70014" style="font-size:50px;line-height:70px !important;">' . $str_1 . '</td>';
        $str = str_replace(array(
            '-',
            '*****'
        ) , array(
        ...
        $str = str_replace($arr_search, $arr_replace, $str);
        $g3 .= '<td class="' . $class . 'bg-gray t-cen font70014" style="font-size:50px;line-height:50px !important;">' . $str . '</td>';
        $str = str_replace('*****', '<img src="' . img_link('icon-xs/loading.gif') . '" width="40" alt="" height="10" />', $value->data[2]);
        $str = str_replace($arr_search, $arr_replace, $str);
        $g2 .= '<td class="' . $class . 't-cen font70014" style="font-size:50px;line-height:50px !important;">' . $str . '</td>';
        $str = str_replace('*****', '<img src="' . img_link('icon-xs/loading.gif') . '" width="40" alt="" height="10" />', $value->data[1]);
        $str = str_replace($arr_search, $arr_replace, $str);
        $g1 .= '<td class="' . $class . 'bg-gray t-cen font70014" style="font-size:50px;line-height:50px !important;">' . $str . '</td>';
        $str = str_replace(str_repeat('*', strlen($value->data[0])) , '<img src="' . img_link('icon-xs/loading.gif') . '" width="40" alt="" height="10" />', $value->data[0]);
        $str = str_replace($arr_search, $arr_replace, $str);
        $g0 .= '<td class="' . $class . 't-cen font70014" style="font-size:70px;line-height:70px !important;"><strong class="red">' . $str . '</strong></td>';
