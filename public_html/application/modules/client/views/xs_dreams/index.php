<h1 style="position: absolute; text-indent: -99999px">GIẢI MỘNG - SỐ MƠ - THƠ ĐỀ<?php echo isset($_GET["title"]) ? ' - ' . $_GET["title"] : '' ?></h1>
<div class="title title-red">
    <div class="title-right">GIẢI MỘNG - SỐ MƠ - THƠ ĐỀ<?php echo isset($_GET["title"]) ? ' - ' . $_GET["title"] : '' ?></div>
</div>
<div class="box-result">								
    ...
    <table class="tbl-ds">
        ...
        <?php
		if(count($rows) < 1){			
			header('Location: http://www.xoso.com/404_override'); 
			die;
		}
