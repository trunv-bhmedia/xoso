...
//        var_dump($data_mega);die;
    ...
    public function choithu6($page = 1) {
        $limit = 10;
        $offset = ($page - 1) * $limit;
        $url = base_url() . 'vietlott/choithu6.html';
        $url_alias = base_url() . 'vietlott/choithu6';
        if (strpos($link_uri, '/vietlott/choithu6.html') == true) {
            $this->data['_meta']['title'] = "Chơi thử mega 6/45 - Xổ số VIETLOTT" ;
            $this->data['_meta']['description'] = "Ưng dụng CHƠI THỬ - MEGA 6/45. Mời các bạn cùng trải nghiệm,thật nhất, chính xác nhất, hướng dẫn cách chơi , Cách chơi , chơi thử vietlott";
            $this->data['_meta']['keywords'] = "chơi thử mega 6/45, choi thu, chơi thử vietlott, huong dan chơi mega 6/45, cách chơi, hướng dẫn chơi vietlott, xổ số, vietlott, xổ số hôm nay, vietlott hôm nay, vietlott moi, vietlott kiểu Mỹ";
        } else {
            $this->data['_meta']['title'] = "Chơi thử mega 6/45 - Xổ số VIETLOTT" ;
            $this->data['_meta']['description'] = "Ưng dụng CHƠI THỬ - MEGA 6/45. Mời các bạn cùng trải nghiệm,thật nhất, chính xác nhất, hướng dẫn cách chơi , Cách chơi , chơi thử vietlott";
            $this->data['_meta']['keywords'] = "chơi thử mega 6/45, choi thu, chơi thử vietlott, huong dan chơi mega 6/45, cách chơi, hướng dẫn chơi vietlott, xổ số, vietlott, xổ số hôm nay, vietlott hôm nay, vietlott moi, vietlott kiểu Mỹ";
        ...
        $this->pagination->initialize($conf);
        $this->data['pagnav'] = $this->pagination->display_ul_li_router($url_alias);
        $this->data['tmpl'] = 'vietlott/choithu6';
        $this->load->view('layout/choithu6', $this->data);
    }
    public function choithupower6($page = 1) {
        $limit = 10;
        $offset = ($page - 1) * $limit;
        $url = base_url() . 'vietlott/choithupower6.html';
        $url_alias = base_url() . 'vietlott/choithupower6';
        if (strpos($link_uri, '/vietlott/choithupower6.html') == true) {
            $this->data['_meta']['title'] = "Chơi thử mega 6/45 - Xổ số VIETLOTT" ;
            $this->data['_meta']['description'] = "Ưng dụng CHƠI THỬ - MEGA 6/45. Mời các bạn cùng trải nghiệm,thật nhất, chính xác nhất, hướng dẫn cách chơi , Cách chơi , chơi thử vietlott";
            $this->data['_meta']['keywords'] = "chơi thử mega 6/55, choi thu, chơi thử vietlott, huong dan chơi mega 6/45, cách chơi, hướng dẫn chơi vietlott, xổ số, vietlott, xổ số hôm nay, vietlott hôm nay, vietlott moi, vietlott kiểu Mỹ";
        } else {
            $this->data['_meta']['title'] = "Chơi thử mega 6/45 - Xổ số VIETLOTT" ;
            $this->data['_meta']['description'] = "Ưng dụng CHƠI THỬ - MEGA 6/45. Mời các bạn cùng trải nghiệm,thật nhất, chính xác nhất, hướng dẫn cách chơi , Cách chơi , chơi thử vietlott";
            $this->data['_meta']['keywords'] = "chơi thử mega 6/55, choi thu, chơi thử vietlott, huong dan chơi mega 6/45, cách chơi, hướng dẫn chơi vietlott, xổ số, vietlott, xổ số hôm nay, vietlott hôm nay, vietlott moi, vietlott kiểu Mỹ";
        ...
        $this->pagination->initialize($conf);
        $this->data['pagnav'] = $this->pagination->display_ul_li_router($url_alias);
        $this->data['tmpl'] = 'vietlott/choithupower6';
        $this->load->view('layout/choithu6', $this->data);
    }
    public function choithumax4d($page = 1) {
        $limit = 10;
        $offset = ($page - 1) * $limit;
        $url = base_url() . 'vietlott/choithumax4d.html';
        $url_alias = base_url() . 'vietlott/choithumax4d';
        if (strpos($link_uri, '/vietlott/choithumax4d.html') == true) {
            $this->data['_meta']['title'] = "Chơi thử max 4d - Xổ số VIETLOTT" ;
            $this->data['_meta']['description'] = "Ưng dụng CHƠI THỬ - Max 4d. Mời các bạn cùng trải nghiệm,thật nhất, chính xác nhất, hướng dẫn cách chơi , Cách chơi , chơi thử vietlott";
            $this->data['_meta']['keywords'] = "chơi thử max 4d, choi thu, chơi thử vietlott, huong dan chơi mega 6/45, cách chơi, hướng dẫn chơi vietlott, xổ số, vietlott, xổ số hôm nay, vietlott hôm nay, vietlott moi, vietlott kiểu Mỹ";
        } else {
            $this->data['_meta']['title'] = "Chơi thử max 4d - Xổ số VIETLOTT" ;
            $this->data['_meta']['description'] = "Ưng dụng CHƠI THỬ - Max 4d. Mời các bạn cùng trải nghiệm,thật nhất, chính xác nhất, hướng dẫn cách chơi , Cách chơi , chơi thử vietlott";
            $this->data['_meta']['keywords'] = "chơi thử max 4d, choi thu, chơi thử vietlott, huong dan chơi mega 6/45, cách chơi, hướng dẫn chơi vietlott, xổ số, vietlott, xổ số hôm nay, vietlott hôm nay, vietlott moi, vietlott kiểu Mỹ";
        ...
        $this->pagination->initialize($conf);
        $this->data['pagnav'] = $this->pagination->display_ul_li_router($url_alias);
        $this->data['tmpl'] = 'vietlott/choithumax4d';
        $this->load->view('layout/choithu6', $this->data);
    }
