...
//        echo $this->db->last_query();
		...
		$this->data['_meta']['title'] = "Xổ số điện toán ngày ".$date;
		$this->data['_meta']['description'] = "Xo so dien toan ngày ".$date." - Kết quả xổ số điện toán chính xác và nhanh nhất trong ngày tại chuyên trang về xổ số Xoso.com hàng đầu tại Việt Nam";
