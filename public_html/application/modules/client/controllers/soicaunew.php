...
class soicaunew extends Client {
    ...
    public function index() {
		...
		$this->data['_meta']['title'] = "Soi cầu, kết quả soi cau loto xổ số";
		$this->data['_meta']['description'] = "Soi cầu, kết quả soi cau loto xổ số, bí quyết soi cầu chính xác miễn phí, thống kê kết quả soi cầu lô chỉ có tại xoso.com";
		$this->data['_meta']['keywords'] = "soi cầu, soi cau, soi cầu loto, soi cầu xổ số, soi cau loto, soi cau xo so, soi cầu lô, soi cau xsmb";
