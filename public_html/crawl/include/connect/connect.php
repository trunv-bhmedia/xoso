...
//    var $username = 'xoso';        // MySQL Username
//    var $password = 'jGsCpNTfdjpBzwnj';        // MySQL Password
    var $username = 'xoso';        // MySQL Username
    var $password = 'xs123654';        // MySQL Password
    var $database = 'xosov2';        // MySQL Database
    var $conn;                // Database Connection Link

    /*     * ******************
     * Class Constructor *
     * ****************** */
// ALTER USER 'xoso'@'localhost' IDENTIFIED WITH mysql_native_password BY 'jGsCpzwnj';
    function MyDBO($database = 'xosov2', $username = 'xoso', $password = 'xs123654', $hostname = 'localhost') {
