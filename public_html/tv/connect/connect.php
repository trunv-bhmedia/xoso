...
// Base variables
    ...
    var $hostname = '123.30.178.123';        // MySQL Hostname
    var $username = 'clip_213';        // MySQL Username
    var $password = 'hainh123465';        // MySQL Password
    var $database = 'bhmedia_clip';        // MySQL Database
    ...
    function MyDBO($database = 'bhmedia_clip', $username = 'clip_213', $password = 'hainh123465', $hostname='123.30.178.123'){
