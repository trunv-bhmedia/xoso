...
//                    $magiai = 'db';
    ...
    function get_xstt_minhngoc($area, $row) {
       ...
       // );
        ...
        //$html = file_get_contents($link[$area]);
        //$html = 'kqxs.mb={run:1,tinh:"46",ntime:1496919654,delay:7000,kq:{46:{lv:"6XQ-9XQ-14XQ",7:["74","17","94","76"],6:["085","873","767"],5:["7640","5730","1046","0573","4241","5061"],4:["9075","8393","8558","2164"],3:["95822","39311","36093","43181","28847","53854"],2:["33618","87113"],1:"94681",0:"+++++"}},dt:{d123:{run:1,kq:["4","53","354"]},dtt4:{run:1,kq:["4022"]},dmax4d:{run:1,kq:{id:7,g:["0209","5986","9818","1597","5179","7119"],kt:{1:"B",2:"A",3:"C"}}}}};';
        if (!$html) {
            $this->saveLog($link[$area] . ' - HTML empty!');
            unset($html);
            return false;
