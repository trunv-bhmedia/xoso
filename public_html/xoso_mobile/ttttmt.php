...
// }
 ...
 $key = '';
 if (!$key) {
     $html = file_get_contents("http://xoso.com.vn/xo-so-mien-trung/xsmt-p1.html"); 
 } 
 ...
 preg_match($regid, $html, $matches);
	...
	$link = 'http://xoso.com.vn/lottery_ws/LotteryWCFService.svc/GetLotteryMsgLiveByGroup/3,1,21,1,4,'.$key.',1';
	//var_dump($link); die;
