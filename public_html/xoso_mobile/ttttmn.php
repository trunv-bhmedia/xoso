...
for ($i = 0; $i < count($data); $i++) {
    ...
    for ($j = 0; $j < count($rs_array2); $j++) {
        if ($rs_array2[8]->Range == "..." && $rs_array2[0]->Range != "...") {
            $quay = "dangquay";
...
//         $str = strlen($rs_array2[$j]) == 1 ? $rs_array2[$j] . "." : $rs_array2[$j];
        ...
        if ($j == 0) {
			...
			$html = "<" . $data[$i]->LotteryCode . ">" . "\n";
        }
        if ($j == 0) {
            if ($rs_array2[$j]->Range == "...") {
                echo "<" . $giai . ">." . $rs_array2[$j]->Range . "</" . $giai . ">" . "\n" . "<" . $giai2 . ">." . $str . "</" . $giai2 . ">" . "\n";
				$html = "<" . $giai . ">." . $rs_array2[$j]->Range . "</" . $giai . ">" . "\n" . "<" . $giai2 . ">." . $str . "</" . $giai2 . ">" . "\n";
			} else {
                echo "<" . $giai . ">" . $rs_array2[$j]->Range . "</" . $giai . ">" . "\n" . "<" . $giai2 . ">" . $str . "</" . $giai2 . ">" . "\n";
				$html = "<" . $giai . ">" . $rs_array2[$j]->Range . "</" . $giai . ">" . "\n" . "<" . $giai2 . ">" . $str . "</" . $giai2 . ">" . "\n";
			}
...
//     $total = count($arr_loto);
    ...
    echo "</" .  $data[$i]->LotteryCode . ">" . "\n";
	$html = "<dau0>" . $duoi0 . "</dau0>" . "\n";
	$html = "<dau1>" . $duoi1 . "</dau1>" . "\n";
	$html = "<dau2>" . $duoi2 . "</dau2>" . "\n";
	$html = "<dau3>" . $duoi3 . "</dau3>" . "\n";
	$html = "<dau4>" . $duoi4 . "</dau4>" . "\n";
	$html = "<dau5>" . $duoi5 . "</dau5>" . "\n";
	$html = "<dau6>" . $duoi6 . "</dau6>" . "\n";
	$html = "<dau7>" . $duoi7 . "</dau7>" . "\n";
	$html = "<dau8>" . $duoi8 . "</dau8>" . "\n";
	$html = "<dau9>" . $duoi9 . "</dau9>" . "\n";
	$html = "<name>" . $data[$i]->LotteryName . "</name>" . "\n";
	$html = "<date>" . $data[$i]->CrDateTime . "</date>" . "\n";
	$html = "<status>" . $quay . "</status>" . "\n";
	$html = "</" .  $data[$i]->LotteryCode . ">" . "\n";
}
echo "</kqxs>";
$html = "</kqxs>";
