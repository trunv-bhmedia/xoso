...
if ($area == 'MB') {
    ...
    <table class="tbl-xs">
        ...
        <tr>
            <?php for ($i = 0; $i <= $l1; $i++): ?>
                <td class="<?php echo($i == $l1 ? '' : 'border-right'); ?>"><strong><?php echo $arr[$i] ?></strong></td>
            <?php endfor; ?>							
        </tr>
        <tr>
            <?php for ($i = ($l1 + 1); $i <= $l2; $i++): ?>
                <td class="<?php echo($i == $l2 ? '' : 'border-right'); ?>"><strong><?php echo $arr[$i] ?></strong></td>
            <?php endfor; ?>							
        </tr>
        <tr>
            <?php for ($i = ($l2 + 1); $i <= $l3; $i++): ?>
                <td class="<?php echo($i == $l3 ? '' : 'border-right'); ?>"><strong><?php echo $arr[$i] ?></strong></td>
            <?php endfor; ?>							
        </tr>
    </table>
    <?php
