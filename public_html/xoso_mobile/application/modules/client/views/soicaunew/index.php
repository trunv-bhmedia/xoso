...
<style type="text/css">
    .contentbox_header {height:auto;line-height:15px;padding:4px 0}
</style>
<h1 style="position: absolute; text-indent: -99999px">Soi cầu toàn diện</h1>
<div class="page-title-xs"><strong>Soi cầu toàn diện</strong></div>
<div class="box-result">
    <form name=f action='<?php echo $uri_root ?>soi-cau.html' method="get" style='padding:10px;text-align:center;font-size:12px'>
        ...
        <input style="margin:5px 0" type=submit class=button value=' Soi cầu ' />
