...
if ($area == 'MB') {
    ...
    <div class="tit-xs clearfix">
        <strong class="title-xs">TRỰC TIẾP XỔ SỐ <?php echo ($l_area); ?> - <?php echo $date; ?></strong>
        <div class="menuRight">
    ...
    <table class="tbl-xs">
        ...
        <tr>
            <?php for ($i = 0; $i <= $l1; $i++): ?>
                <td class="<?php echo($i == $l1 ? 'last' : 'border-right'); ?>"><strong><?php echo substr($arr[$i], -2, 2); ?></strong></td>
            <?php endfor; ?>							
        </tr>
        <tr>
            <?php for ($i = ($l1 + 1); $i <= $l2; $i++): ?>
                <td class="<?php echo($i == $l2 ? 'last' : 'border-right'); ?>"><strong><?php echo substr($arr[$i], -2, 2); ?></strong></td>
            <?php endfor; ?>							
        </tr>
        <tr>
            <?php for ($i = ($l2 + 1); $i <= $l3; $i++): ?>
                <td class="<?php echo($i == $l3 ? 'last' : 'border-right'); ?>"><strong><?php echo substr($arr[$i], -2, 2); ?></strong></td>
            <?php endfor; ?>							
        </tr>
    </table>
    <?php
    ...
    ?>
    <div class="tit-xs clearfix">
        <strong class="title-xs">TRỰC TIẾP XỔ SỐ <?php echo mb_strtoupper($l_area, 'UTF-8') ?> - <?php echo $date; ?></strong>
        <div class="menuRight">
            <a href="<?php echo $area == 'MT' ? $uri_root . $url_mientrung : $uri_root . $url_miennam ?>.html"><img src="<?php echo img_link('date.png'); ?>" width="15" height="16" alt="" /></a>
        </div>
    </div>
    <div class="page-title">
        <strong class="txt-red"><h2>Xổ số <?php echo $l_area ?> mở thưởng ngày <?php echo($days[$datew]); ?> - <?php echo $date; ?></h2></strong>
    </div>
    <table class="tbl-xs">
        <tr>
    ...
    <div class="tit-xs clearfix">
        <strong class="title-xs">BẢNG LOTO TRỰC TIẾP XỔ SỐ <?php echo ($l_area); ?> - <?php echo $date; ?></strong>
    </div>
    <table class="tbl-xs">
        <tr>
            <?php echo $title_loto ?>
