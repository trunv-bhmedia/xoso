...
<div class="page-title t-cen">
    <strong><h1>Thống kê đầu đuôi 0-9 Xổ số <?php echo $lname ?></h1></strong>
</div>
<?php if ($items): ?>
    <div class="title-tk"><strong>Đầu số xuất hiện trong <?php echo $time_turn ?> lần quay Xổ số <?php echo $lname ?></strong></div>
    <table class="tbl-ds">
        <tr>
            <td width="70">đặc biệt </td>
            <td width="210">Lần xuất hiện</td>
            <td width="33">Loto</td>
            <td width="210" class="last">Lần xuất hiện</td>
        </tr>
        <?php
    ...
    <div class="title-tk"><strong>Đuôi số xuất hiện trong <?php echo $time_turn ?> lần quay Xổ số <?php echo $lname ?></strong></div>
    <table class="tbl-ds">
        <tr>
            <td width="70">đặc biệt </td>
            <td width="210">Lần xuất hiện</td>
