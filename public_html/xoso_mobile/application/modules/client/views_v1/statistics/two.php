...
<div class="page-title t-cen">
    <strong><h1>Thống kê cặp số từ 00-99 Xổ số <?php echo $lname ?></h1></strong>
</div>
<?php if ($items) { ?>
    <div class="title-tk"><strong><?php echo 'Các số xuất hiện trong ' . $time_turn . ' lần quay Xổ số '; ?><?php echo $lname ?></strong></div>
    <table class="tbl-ds">
        <tr>
            <td class="t-cen">Cặp số</td>
            <td class="last t-cen">Lần xuất hiện</td>
        </tr>
        <?php
