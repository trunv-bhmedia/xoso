    ...
    <form id="form_doveso" name="form_doveso" method="get" action="">
        <div class="rows clearfix">
            <div class="clearfix rows datefrom">
                <label class="label-title">Ngày</label>
        ...
        <div class="rows clearfix">
            <div class="clearfix rows datefrom">
                <label class="label-title">Tỉnh</label>
                <div style="display:inline-block" id="boxCity"></div>
            </div>
        </div>
        <div class="rows seque clearfix">
            <label class="label-title">Vé số</label>
            <span class="span-input space"><input class="txt-input txt-liver" type="text" id="so" name="so" value="<?php echo $so ?>" maxlength="6" /></span>
        </div>
...
if ($so > 0) {
    ...
    if ($items) {
        ...
        <?php } elseif ($result == 999) { ?>
            ...
            <div class="t-cen box-dvs">
                ...
                <div class="gray-text">
                    <p><strong class="red">Chúc mừng bạn!</strong> <br  />
    ...
    if ($items) {
        ...
        <div class="tit-xs clearfix">
            <strong class="title-xs">KẾT QUẢ XỔ SỐ <?php echo $l_area ?></strong>
            <div class="menuRight">
        ...
        <div class="box-result">
            <table class="tbl-xs <?php echo $class ?>">
                <tr>
                    <td colspan="2" class="t-left border-right">
                    ...
                    <td class="last t-right">Giải thưởng(đ)</td>
                </tr>
                <tr>
