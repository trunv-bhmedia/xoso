...
//            }
        ...
        if(strpos($link_uri, '/mien-bac.html') == true){
			$this->data['_meta']['title'] = "Xem trực tiếp kết quả xổ số miền bắc tren mobile";
		...
		}elseif(strpos($link_uri, '/mien-trung.html') == true){
			$this->data['_meta']['title'] = "Xem trực tiếp kết quả xổ số miền trung tren mobile";
		...
		}elseif(strpos($link_uri, '/mien-nam.html') == true){
			$this->data['_meta']['title'] = "Xem trực tiếp kết quả xổ số miền nam tren mobile";
			...
			$this->data['_meta']['title'] = "Xem truc tiep ket qua xo so tren mobile";
