        ...
        if (isset($items[0])) {
            ...
            <div class="box_kqxs_mienbac">
                <div class="boxtop">
                    ...
                    <div class="apdung">(Áp dụng chung khu vực Miền Bắc)</div>
                    <div class="loaive">Loại vé: 10.000 đ</div>
                    <div class="kyhieu">Ký hiệu: XSMB</div>
                    <div class="ngay">Mở thưởng <strong><?php echo $item->dateOfWeek ?></strong> ngày: <span class="txtngay"> <?php echo $item->date ?></span></div>
                </div>
                <div class="box_kqxs">
                    ...
                    <div class="bottom2">Kính Chúc Quý Khách May Mắn Phát Tài!..</div>
                </div>
                <div class="bottom">wWw.XOSO.Com</div>
            </div>
            <?php
            $str = ob_get_contents();
            ob_end_clean();
