...
<div class="box-yellow select-provice box-ticket t-cen">
    <form id="form_doveso" name="form_doveso" method="get" action="">
        <div class="clearfix rows datefrom">
            ...
            <label class="left">Tỉnh</label>
            <div class="left" id="boxCity"></div>
            <label class="left">Vé số</label>
            <span class="span-input span-input1"><input type="text" id="so" name="so" value="<?php echo $so ?>" maxlength="6" /></span>
        </div>
        ...
        if ($items) {
            ...
            <?php } elseif ($result == 999) { ?>
                ...
                <div class="box-gray clearfix">
                    ...
                    <div class="gray-text">
                        <p><strong>Chúc mừng bạn!</strong> <br  />
                            Vé số của bạn đã trúng giải <?php echo $giai ?>!<br />
                            Tổng giá trị giải thưởng là <strong><?php echo $trigia ?>đ</strong><br />
            <!--                        <p><a class="read-more" href="#"><span>Đổi số trúng</span></a></p>-->
                    </div>
                </div>
            <?php } ?>
        <?php } else { ?>
    ...
    if ($items) {
        ...
        <div class="title title-red">
            <div class="title-right clearfix"><strong class="left">KẾT QUẢ XỔ SỐ <?php echo $l_area ?></strong>
                <a href="<?php echo $uri_root . $url ?>.html" class="right view-table">Xem bảng tính <span>&nbsp;</span></a>
            </div>
        </div>
        <div class="box-result">
            <table class="tbl-tt<?php echo $class ?>">
                ...
                <tr>
                    ...
                    <td class="last bg-gray t-right"><strong><?php echo $giaithuong[0] ?></strong></td>
                </tr>
                <tr>
                    ...
                    <td class="last t-right"><?php echo $giaithuong[1] ?></td>
                </tr>
                <tr>
                    ...
                    <td class="last t-right bg-gray"><?php echo $giaithuong[2] ?></td>
                </tr>
                <tr>
                    ...
                    <td class="last t-right"><?php echo $giaithuong[3] ?></td>
                </tr>
                <tr>
                    ...
                    <td class="last t-right bg-gray "><?php echo $giaithuong[4] ?></td>
                </tr>
                <tr>
                    ...
                    <td class="last t-right"><?php echo $giaithuong[5] ?></td>
                </tr>
                <tr>
                    ...
                    <td class="last t-right bg-gray"><?php echo $giaithuong[6] ?></td>
                </tr>
                <tr>
                    ...
                    <td class="last t-right"><?php echo $giaithuong[7] ?></td>
                </tr>
                <?php
                if ($items->area != 'MB') {
                    if (strlen($items->a0) == 5) {
                        ...
                        <tr>
                            ...
                            <td class="bg-gray last t-right"><?php echo $giaithuong[8] ?></td>
                        </tr>
                        <tr>
                            ...
                            <td class="last t-right"><?php echo $giaithuong[10] ?></td>
                        </tr>
                        <?php
                    } else {
                        ?>
        ...
        <ul class="list-editor space1">
            <li>Để nhận kết quả xổ số <strong><?php echo $lname ?></strong> sớm nhất, soạn tin <span>KQ <?php echo $items->code ?></span> gửi <span>8117</span></li>
        </ul>
        <?php
        $lid_ve_do = 1;
        $url_veso = 'mien-bac';
        ...
        <div class="tabs-note space-pleft clearfix">
            <a class="span-in" target="_blank" href="<?php echo $uri_root ?>ve-do.html?l=<?php echo $lid_ve_do ?>&amp;d=<?php echo $date_ve_do ?>&amp;t=2">In vé dò</a>
