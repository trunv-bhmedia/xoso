...
<div class="box-result">								
    ...
    <div class="rate-box">
        <p><strong>Thống kê đầu đuôi loto <a href="<?php echo $statistics_alias ?>.html"><?php echo $lname ?></a>:</strong> Thống kê đưa ra tần suất xuất hiện theo biểu đồ của đầu đuôi các
            bộ số dựa vào số lần quay thưởng</p>
        <ul>
            <li><strong>Bước 1:</strong> Chọn tỉnh thành muốn xem</li>
            <li><strong>Bước 2:</strong> Chọn số lần quay</li>
            <li><strong>Bước 3:</strong> Click "Xem kết quả" để xem thông tin chi tiết</li>
        </ul>
    </div>
