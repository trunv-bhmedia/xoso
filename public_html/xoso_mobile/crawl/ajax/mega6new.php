...
function get_data($drawid) {
    ...
    if (count($arr_cat)) {
        ...
        <div class="jackpost-xx mega645-box" >
            <h2 class="jackpost-xx-h2">KẾT QUẢ TRÚNG THƯỞNG<br>MEGA 6/45<small>Ngày quay thưởng <?php echo date('d/m/Y', $obj_cat->dateint); ?></small></h2>
            <div class="jackpost-xx-content" >
                <div class="jackpost-xx-content-top">
                    ...
                    <div class="button-slide">                                
                        <a class="mega-result-btn" href="javascript:void(0)" onclick=" return prevNextResultGameMega645(this, 1)" data-gameid="3" data-drawid="<?php echo $obj_cat->drawId - 1; ?>" data-dayprize="<?php echo date('n/j/Y', $obj_cat->dateint); ?> 12:00:00 AM">
                            <i class="fa fa-angle-left"></i>
                        </a>
                        <a class="mega-result-btn" href="javascript:void(0)" onclick=" return prevNextResultGameMega645(this, 0)" data-gameid="3" data-drawid="<?php echo $obj_cat->drawId + 1; ?>" data-dayprize="<?php echo date('n/j/Y', $obj_cat->dateint); ?> 12:00:00 AM">
